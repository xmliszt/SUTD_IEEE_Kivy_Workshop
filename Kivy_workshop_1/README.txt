...
* Topics covered:
    - How to create and run your kivy app
    - Differentiate and relate .py and .kv file
    - 5 different layouts: {BoxLayout, FloatLayout, StackLayout, GridLayout, PageLayout}
    - Build layouts for a simple calculator and login page

* All the answers for the activities in the slides can be found in this folder!

* The name of the files correspond to the red text added to the workshop slides on each activity page.
...
1. Find "PyCharm_kv_completion.jar" in this folder.
